    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Ενημερώστε τις πληροφορίες προφίλ και τη διεύθυνση email του
                λογαριασμού σας.
            </p>
        </header>
        ...
        >
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="mt-2 text-sm text-gray-800 dark:text-gray-200">
                    ...
                    >
                        Κάντε κλικ εδώ για να στείλετε ξανά το email
                        επαλήθευσης.
                    </Link>
                </p>
                ...
                >
                    Ένας νέος σύνδεσμος επαλήθευσης έχει σταλεί στη διεύθυνση
                    email σας.
                </div>
            </div>
